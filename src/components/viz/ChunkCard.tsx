 ...
 */
export function ChunkCard({ chunk, rank, aside }: ChunkCardProps) {
  ...
  return (
    <article className="rounded-xl border border-ink-200 bg-white p-4 transition-colors hover:border-ink-300">
